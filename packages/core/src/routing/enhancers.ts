...
const enhancerRegistry = new WeakMap<
  Constructor,
  Map<HandlerKey, RouteEnhancer[]>
>();
...
export const registerRouteEnhancer = (
  ...
  const controllerRegistry =
    enhancerRegistry.get(controller) ?? new Map<HandlerKey, RouteEnhancer[]>();
...
export const getRouteEnhancers = (
  controller: Constructor,
...
export const consumeRouteEnhancers = (
  controller: Constructor,
  handlerKey: HandlerKey,
): RouteEnhancer[] => {
  const controllerRegistry = enhancerRegistry.get(controller);
